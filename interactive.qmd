...
This is a very basic example of displaying an interactive visualization using ObservableJS. *Select a question*, repeat. Choose, also, between the *Plot* or *Data* tabs. You'll see the visualizations are reactive to your selections.
