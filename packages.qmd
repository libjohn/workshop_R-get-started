...
[Follow this link](https://tutorials.shinyapps.io/00-setup/ "how to install R and RStudio") for a nice interactive tutorial on installing R and RStudio

## Quarto installation

Quarto comes pre-installed with the latest versions of RStudio. However, if you want to install Quarto again, or for use with VSCode, just to to [Quarto.org](https://quarto.org/docs/get-started/ "Get Started with Quarto")
